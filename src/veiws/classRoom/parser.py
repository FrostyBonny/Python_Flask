...
# putParser =
putParser.add_argument('id', type=str, help='please enter id', required=True)
putParser.add_argument('name', type=str, help='please enter name')
putParser.add_argument('arrived', type=str, help='please enter arrived')
putParser.add_argument('arriveNum', type=int, help='please enter arriveNum')
putParser.add_argument('total', type=int, help='please enter total')
putParser.add_argument('col', type=int, help='please enter col')
putParser.add_argument('row', type=int, help='please enter row')
...
postParser.add_argument('name', type=str, help='please enter name', required=True)
postParser.add_argument('total', type=int, help='please enter total', required=True)
postParser.add_argument('arriveNum', type=int, help='please enter arrived', required=True)
